 ...
 select * from Outware where outclss='7'

 select * from inspect  where orderid='2024040022'
 select * from stuffinreturn where orderid='2024040022'
select * from ordercolor  where orderid='2024040022'


 select * from inspect where orderid='2024040022' and lotno='7'

-- update inspect set lotendclss='0' where  orderid='2024040022' and lotno='7'

 select * from stuffinreturn where orderid='2024040022'

-- update stuffinreturn set lotendclss='0' where keydate='20240417' and keyseq='3' and orderid='2024040022'
