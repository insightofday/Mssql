--printstuffinbydate  rs 
     DECLARE @FromDate   CHAR(8)                                                             
     SET @FromDate = LEFT( '20240213', 6 ) + '01'                                                                
     ...
     INTO #Temp                                                              
     FROM DS22 AA                                                               
     WHERE StuffDate BETWEEN  '20240213'  AND  '20240213'                                                                
     ...
     INTO #Temp1                                                             
     FROM DS22 AA                                                               
     WHERE StuffDate BETWEEN  @FromDate  AND  '20240213'                                                             
...
--printoutwarebydate1  rssub
     DECLARE @Date   CHAR(8)                                                             
     SET @Date = LEFT( '20240213', 6 ) + '01'                                                                
     ...
     INTO  #Temp                                                             
     FROM DS20 C, DSF05 ('20240213', '20240213') B,(select OrderID,AVG(UnitPrice) unitprice FROM DS21 WHERE OrderSeq<> 0 GROUP BY orderid) D 
     ...
     INTO #TEMP1                                                             
     FROM DS20 C, DSF05 (@Date, '20240213') B                                                             
...
--printoutwaredate2  rs2
     DECLARE @Date   CHAR(8)                                                             
     SET @Date = LEFT( '20240113', 6 ) + '01'                                                                
     ...
     INTO  #Temp                                                             
     FROM DS20 C, DSF05 ('20240113', '20240113') B,(select OrderID,AVG(UnitPrice) unitprice FROM DS21 WHERE OrderSeq<> 0 GROUP BY orderid) D 
     WHERE C.OrderID = B.OrderID AND C.OrderID = D.OrderID                                                             
                                                                     
                                                                     
     SELECT  SUM(B.OutRoll) AS OutRoll, SUM(B.OutQtyY) AS OutQtyY, SUM(B.TotalPrice) AS TotalPrice                                                               
     INTO #TEMP1                                                             
     FROM DS20 C, DSF05 (@Date, '20240113') B                                                             
     WHERE C.OrderID = B.OrderID                                                             
