...
select * from ds23 where orderid='202401022'

select * from ds20 where orderid='202401022'

select * from #basestock where orderid='202401022'

select * from #subul where orderid='202401022'
...
FROM (
     ...
     FROM [DS23] AS A
     WHERE A.StuffDate BETWEEN '20240101' AND '20240131'
	 and A.OrderID='202401022'
     GROUP BY A.OrderID, A.ColorID
     ...
     LEFT JOIN [DS20] AS B ON A.OrderID = B.OrderID
     WHERE A.GradeClss < B.DefectClss
       AND A.ExamDate BETWEEN '20240101' AND '20240131'
	   and A.OrderID='202401022'
     GROUP BY A.OrderID, A.ColorID
     ...
     LEFT JOIN [DS24] AS C ON A.OrderID = C.OrderID AND A.RollID = C.RollID
     LEFT JOIN [DS20] AS D ON A.OrderID = D.OrderID
     WHERE A.FixDate BETWEEN '20240101' AND '20240131'
...
WHERE 1 = 1 
AND D.ExamDate BETWEEN '20240101' AND '20240131'
...
SELECT kcustom, orderno, color, article, joindate, COUNT(*) as count
--INTO #duple2
FROM #duplicate
GROUP BY kcustom, orderno, color, article, joindate
HAVING COUNT(*) > 1;

--drop table #duple2

DELETE FROM #duplicate
WHERE (kcustom, orderno, color, article, joindate as count) IN (#duple2);
